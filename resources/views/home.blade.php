...
<body class="px-10 md:px-20 xl:px-40 py-10">
    <header class="bg-white bg-opacity-50 rounded-2xl shadow-lg p-6">
        <img src="img/logo-bri.png" alt="Logo BRI" class="w-64 m-auto">
    ...
    <main>
        <div class="grid grid-cols-2 gap-10 my-10">
            <a href="#"
                ...
                <div class="flex items-center gap-4 flex-col lg:flex-row">
                    <div class="bg-white h-20 w-20 rounded-full flex justify-center items-center">
                        <img src="icons/icon-queue.svg" alt="Icon Queue">
                    </div>
                    <h2 class="text-white text-3xl md:text-4xl font-poppins font-bold">Take Queue</h2>
                </div>
                ...
                <img src="icons/arrow.svg" alt="Arrow" class="w-1/4 self-end">
            </a>
            <a href="#"
                ...
                <div class="flex items-center gap-4 flex-col lg:flex-row">
                    <div class="bg-white h-20 w-20 rounded-full flex justify-center items-center">
                        <img src="icons/icon-teller-cs.svg" alt="Icon Queue">
                    </div>
                    <h2 class="text-white text-3xl md:text-4xl font-poppins font-bold">Teller and CS</h2>
                </div>
                <p class="font-poppins text-white my-4 md:my-8 md:text-lg">
            ...
            <a href="#"
                ...
                <div class="flex items-center gap-4 flex-col lg:flex-row">
                    <div class="bg-white h-20 w-20 rounded-full flex justify-center items-center">
                        <img src="icons/icon-monitor.svg" alt="Icon Queue">
                    </div>
                    <h2 class="text-white text-3xl md:text-4xl font-poppins font-bold">Queue Viewer Page</h2>
                </div>
                <p class="font-poppins text-white my-4 md:my-8 md:text-lg">
            ...
            <a href="#"
                ...
                <div class="flex items-center gap-4 flex-col lg:flex-row">
                    <div class="bg-white h-20 w-20 rounded-full flex justify-center items-center">
                        <img src="icons/icon-settings.svg" alt="Icon Queue">
                    </div>
                    <h2 class="text-white text-3xl md:text-4xl font-poppins font-bold">Settings</h2>
                </div>
                <p class="font-poppins text-white my-4 md:my-8 md:text-lg">
