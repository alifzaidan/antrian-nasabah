...
<body class="p-8">
    <header
        ...
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-primary font-poppins text-xl">Panggilan Antrian <span class="font-bold">Counter 1</span>
            </h1>
        </div>
    ...
    <main>
        <div class="grid sm:grid-cols-4 grid-cols-2 gap-5 my-10">
            ...
            <div class="bg-primary bg-opacity-10 rounded-2xl shadow-lg p-4">
                <div class="bg-white rounded-2xl flex items-center justify-center gap-4 flex-col p-6 h-full">
                    ...
                    <div class="flex gap-4">
                        <img src="{{asset('icons/people-2.svg')}}" alt="Jumlah Antrian" class="w-12">
            ...
            <div class="bg-primary bg-opacity-10 rounded-2xl shadow-lg p-4">
                <div class="bg-white rounded-2xl flex items-center justify-center gap-4 flex-col p-6 h-full">
                    ...
                    <div class="flex gap-4">
                        <img src="{{asset('icons/people-3.svg')}}" alt="Jumlah Antrian" class="w-12">
            ...
            <div class="bg-primary bg-opacity-10 rounded-2xl shadow-lg p-4">
                <div class="bg-white rounded-2xl flex items-center justify-center gap-4 flex-col p-6 h-full">
                    ...
                    <div class="flex gap-4">
                        <img src="{{asset('icons/people-4.svg')}}" alt="Jumlah Antrian" class="w-10">
        ...
        <div class="bg-primary bg-opacity-10 rounded-2xl shadow-lg p-4">
            <div class="bg-white rounded-2xl px-4 py-2">
                <h1 class="my-4 font-poppins font-semibold text-2xl text-center text-primary">Antrean Belum Dipanggil</h1>
        ...
        <div class="bg-primary bg-opacity-10 rounded-2xl shadow-lg p-4">
            <div class="bg-white rounded-2xl px-4 py-2">
                <h1 class="my-4 font-poppins font-semibold text-2xl text-center text-primary">Antrean Sudah Dipanggil</h1>
                <table class="table border w-full text-center">
                    <thead class="bg-primary bg-opacity-10">
                        <tr class="font-poppins font-bold text-lg">
                            <th class="px-4 py-2">No. Antrian</th>
