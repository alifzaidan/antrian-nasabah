...
<head>
    ...
    <meta name="author" content="Internship UIN Malang 2024">
...
<body class="d-flex flex-column h-100">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body text-center d-grid p-5">
                            <div class="border border-success rounded-2 py-2 mb-5">
                                <h3 class="pt-4">ANTRIAN SEKARANG</h3>
    ...
    <footer class="footer mt-auto py-4">
        <div class="container">
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2024 - Internship UIN Malang. All rights reserved.
            </div>
        </div>
    </footer>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#antrian').load('{{ route('nomor-antrian.index') }}');
            $('#insert').on('click', function() {
                $.ajax({
                    type: 'POST'
                    , url: '{{ route('nomor-antrian.store') }}'
                    , success: function(result) {
                        if (result === 'Sukses') {
                            // $('#antrian').load('{{ route('nomor-antrian.index') }}').fadeIn('slow');
                            console.log("Sukses");
                        }
                    }
